...
#define PATH_DYJC_BASE	PATH_BASE"/xtdcu"//
...
#define FILE_DYJC_SYS_CONFIG PATH_BASE"/system/dyjc_sys_config.ini"	//dyjc系统的系统配置//刘志强添加
#define FILE_TERMINAL_CONFIG PATH_BASE"/system/terminal_config.ini"	//终端信息配置
#define CFG_FILE_INI_PORTMAP	PATH_BASE"/system/portmap.ini" //端口配置文件

#define FILE_KELI_ETH0_IP		PATH_BASE"/xtdcu/script/eth0_ip.ini"				//系统IP地址配置文件
#define FILE_KELI_ETH1_IP		PATH_BASE"/xtdcu/script/eth1_ip.ini"				//系统IP地址配置文件
#define CFG_LOCAL_IP 			PATH_BASE"/system/local_ip.ini"	//本地ip

#define PATH_SET_SOURCE PATH_BASE"/xtdcu/set"						//刘志强添加
#define PATH_SET_USER PATH_BASE"/user/xtdcu/set"					//刘志强添加
...
#define NAME_SET_LUXTASK "luxtask.ini"							//光控任务配置文件名
#define NAME_SET_CONSLUXTASK "consluxtask.ini"					//恒照任务配置文件名
...
//
#define PATH_SCRIPT_SOURCE PATH_BASE"/xtdcu/script"				//刘志强添加
#define PATH_SCRIPT_USER PATH_BASE"/user/xtdcu/script"			//刘志强添加
...
//电表规约配置
#define PATH_METER_LIB PATH_BASE"/xtdcu/meterlib/"				//刘志强添加
...
#define FILE_DYJC_STATUS	PATH_BASE"/user/xtdcu/data/status.dat"				//DYJC系统的状态共享内存文件//刘志强添加

//#define PATH_COMMON_RESOURCE_BMP_KELI		"/mnt/keli/resource/bmp/keli.bmp"	//液晶显示图标目录
#define FILE_COMMON_RESOURCE_HZK_HZK12  PATH_BASE"/system/hzk12.bin"
